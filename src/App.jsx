    ...
    <>
      <div  style={{height:'100vh'}}  className="main bg-dark d-flex justify-content-center align-items-center w-100">
         ...
         <div className='text-white text-center'>
          <h1>GK Quiz</h1>
          <Button variant='primary' className='w-100' onClick={nextQuest}>Let's start</Button>
         </div>
         :
        ...
        <div className='quest-box'>
         ...
         <Button  variant='primary' onClick={getMark}>GetMark</Button>
         :<Button style={green?{display:'block'}:{display:'none'}} onClick={nextQuest} variant="primary">NextQuestion</Button>
         }
    </div>
        }
      </div>
